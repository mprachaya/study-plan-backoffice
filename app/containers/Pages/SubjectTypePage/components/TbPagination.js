                ...
                .map((row, index) => {
                  ...
                  return (
                    <TableRow
                      hover
                      tabIndex={-1}
                      key={row.subject_type_id}
                    >
                      <TableCell align="left"><Button variant="contained" onClick={() => openFormUpdate(row.subject_type_id, row.subject_type_name, row.subject_category_name)}>edit</Button></TableCell>
                      <TableCell align="left" ><Button variant="outlined" onClick={() => openAlertDialog(row.subject_type_id, row.subject_type_name)}>delete</Button></TableCell>
                      <TableCell component="th" id={labelId} scope="row">
                        {row.subject_type_name}
                      </TableCell>
                      <TableCell>{row.subject_category_name}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
