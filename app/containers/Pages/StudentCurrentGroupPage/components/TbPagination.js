                ...
                .map((row, index) => {
                  ...
                  return (
                    <TableRow
                      hover
                      tabIndex={-1}
                      key={row.student_cur_group_id}
                    >
                      <TableCell align="left"><Button variant="contained" onClick={() => openFormUpdate(row.student_cur_group_id, row.group_name_th, row.group_name_en, row.group_short_name_th, row.group_short_name_en)}>edit</Button></TableCell>
                      <TableCell align="left" ><Button variant="outlined" onClick={() => openAlertDialog(row.student_cur_group_id, row.group_name_th)}>delete</Button></TableCell>
                      <TableCell component="th" id={labelId} scope="row">
                        {row.group_name_th}
                      </TableCell>
                      <TableCell align="left">{row.group_name_en}</TableCell>
                      <TableCell align="left">{row.group_short_name_th}</TableCell>
                      <TableCell align="left">{row.group_short_name_en}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
