                ...
                .map((row, index) => {
                  ...
                  return (
                    <TableRow
                      ...
                      key={row.faculty_id}
                    >
                      <TableCell align="left"><Button variant="contained" onClick={() => openFormUpdate(row.faculty_id, row.faculty_name_th, row.faculty_name_en)}>edit</Button></TableCell>
                      <TableCell align="left" ><Button variant="outlined" onClick={() => openAlertDialog(row.faculty_id, row.faculty_name_th)}>delete</Button></TableCell>
                      <TableCell component="th" id={labelId} scope="row">
                        {row.faculty_name_th}
                      </TableCell>
                      <TableCell align="left">{row.faculty_name_en}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
