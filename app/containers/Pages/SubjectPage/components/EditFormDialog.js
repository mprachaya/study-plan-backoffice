...
export default function EditFormDialog(props) {
  ...
  const { handleSnackbar, groupSelection } = props;

  const [state, setState] = useState({
    curriculum_id: fieldValue.curriculumId,
    group_type_id: fieldValue.groupTypeId,
    subject_id: fieldValue.subjectId,
    subject_code: fieldValue.subjectCode,
    subject_name_th: fieldValue.subjectNameTh,
    subject_name_en: fieldValue.subjectNameEn,
    credit_qty: fieldValue.creditQty,
    subject_description: fieldValue.subjectDescription,
  });
