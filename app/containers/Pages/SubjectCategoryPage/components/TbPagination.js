                ...
                .map((row, index) => {
                  ...
                  return (
                    <TableRow
                      hover
                      tabIndex={-1}
                      key={row.subject_category_id}
                    >
                      <TableCell align="left"><Button variant="contained" onClick={() => openFormUpdate(row.subject_category_id, row.subject_category_name)}>edit</Button></TableCell>
                      <TableCell align="left" ><Button variant="outlined" onClick={() => openAlertDialog(row.subject_category_id, row.subject_category_name)}>delete</Button></TableCell>
